...
const AdminDashboard = () => {
    ...
    const totalProducts = getAllProduct?.length || 0;
                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        <div className="">
                            ...
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Email :</span>{user?.gmail} </h1>
                        ...
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-pink-50 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-pink-400 fonts1" >{totalProducts}</h2>
