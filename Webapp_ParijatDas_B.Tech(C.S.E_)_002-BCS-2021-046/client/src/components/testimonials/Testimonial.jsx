    ...
    <div>
      <section className='text-gray-600 body-font mb-10'>
        ...
        <div className='container px-5 py-10 mx-auto'>
            <h1 className='text-center text-2xl font-bold text-black'>Testimonials</h1>
            <h2 className='text-center text-2xl font-semibold mb-10'>What's Our <span className='text-pink-200'>Customers</span> are saying</h2>
